...
class Gui {
    ...
    load(id) {
        ...
        document.getElementById("7").style.display = this.id == 7 ? 'block' : 'none'
        document.getElementById("8").style.display = this.id == 8 ? 'block' : 'none'
        document.getElementById("9").style.display = this.id == 9 ? 'block' : 'none'
        document.getElementById("10").style.display = this.id == 10 ? 'block' : 'none'
        document.getElementById("11").style.display = this.id == 11 ? 'block' : 'none'
        document.getElementById("12").style.display = this.id == 12 ? 'block' : 'none'
        document.getElementById("13").style.display = this.id == 13 ? 'block' : 'none'
        document.getElementById("14").style.display = this.id == 14 ? 'block' : 'none'
        document.getElementById("15").style.display = this.id == 15 ? 'block' : 'none'
        document.getElementById("16").style.display = this.id == 16 ? 'block' : 'none'
        document.getElementById("17").style.display = this.id == 17 ? 'block' : 'none'
        document.getElementById("18").style.display = this.id == 18 ? 'block' : 'none'
        document.getElementById("19").style.display = this.id == 19 ? 'block' : 'none'
        document.getElementById("20").style.display = this.id == 20 ? 'block' : 'none'
    }
...
const guiData = {
    ...
    start: [{
        ...
        //Lugar donde colocar a pegman en la recta 
        rect: {
            x: 38,
            y: 190
        }
