...
class Game {
    ...
    checkGameStatus(request, back, old) {
        ...
        if (request.method == Blockly.Gamepad['STATES']['FINISHED'] && !back) {
            ...
            switch (id) {
                case  0:
                    window.open('encuesta.html',"ventana1","width=380,height=300,scrollbars=NO")
                break;
            
                case 1:
                    window.open('encuesta.html#pregunta 2',"ventana1","width=380,height=300,scrollbars=NO")
                break;

                case 2:
                    window.open('encuesta.html#pregunta 3',"ventana1","width=380,height=300,scrollbars=NO")
                break;

                case 3:
                    window.open('encuesta.html#pregunta 4',"ventana1","width=380,height=300,scrollbars=NO")
                break;

                case 4:
                    window.open('encuesta.html#pregunta 5',"ventana1","width=380,height=300,scrollbars=NO")
                break;   

                case 5:
                    window.open('encuesta.html#pregunta 6',"ventana1","width=380,height=300,scrollbars=NO")
                break;

                case 6:
                    window.open('encuesta.html#pregunta 7',"ventana1","width=380,height=300,scrollbars=NO")
                break;

                case 7:
                    window.open('encuesta.html#pregunta 8',"ventana1","width=380,height=300,scrollbars=NO")
                break;

                case 8:
                    window.open('encuesta.html#pregunta 9',"ventana1","width=380,height=300,scrollbars=NO")
                break;

                case 9:
                    window.open('encuesta.html#pregunta 10',"ventana1","width=380,height=300,scrollbars=NO")
                break;

                case 10:
                    window.open('encuesta.html#pregunta 11',"ventana1","width=380,height=300,scrollbars=NO")
                break;

                case 11:
                    window.open('encuesta.html#pregunta 12',"ventana1","width=380,height=300,scrollbars=NO")
                break;

                case 12:
                    window.open('encuesta.html#pregunta 13',"ventana1","width=380,height=300,scrollbars=NO")
                break;

                case 13:
                    window.open('encuesta.html#pregunta 14',"ventana1","width=380,height=300,scrollbars=NO")
                break;

                case 14:
                    window.open('encuesta.html#pregunta 15',"ventana1","width=380,height=300,scrollbars=NO")
                break;

                case 15:
                    window.open('encuesta.html#pregunta 16',"ventana1","width=380,height=300,scrollbars=NO")
                break;

                case 16:
                    window.open('encuesta.html#pregunta 17',"ventana1","width=380,height=300,scrollbars=NO")
                break;

                case 17:
                    window.open('encuesta.html#pregunta 18',"ventana1","width=380,height=300,scrollbars=NO")
                break;

                case 18:
                    window.open('encuesta.html#pregunta 19',"ventana1","width=380,height=300,scrollbars=NO")
                break;

                case 19:
                    window.open('encuesta.html#pregunta 20',"ventana1","width=380,height=300,scrollbars=NO")
                break;
        ...
        var re = request
        console.log ('pedido', re)
        
        var ty =  back ? 'backward' : 'forward'

        console.log('tipo de solicitud', ty)
        
        var js =('pegman', JSON.parse(JSON.stringify(pegman)))
        
        console.log('Peeeeeeeeeeegman', js)
